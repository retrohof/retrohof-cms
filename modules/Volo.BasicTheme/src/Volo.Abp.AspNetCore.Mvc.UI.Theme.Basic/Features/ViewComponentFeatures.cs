...
{
    public static class ViewComponentFeatures
    {
        // Layout View Components
        public const string TopNavbarToolbar = "TopNavbarToolbar";
        public const string MainNavbar = "MainNavbar";
        public const string Slider = "Slider";
        public const string Suppliers = "Suppliers";
        public const string Footer = "Footer";

        // Index Page View Components
