...
namespace Volo.Abp.AspNetCore.Mvc.UI.Theme.Basic.Themes.Mdw.Components.Toolbar.UserMenu;
...
public class UserMenuViewComponent : AbpViewComponent
{
    ...
    public virtual async Task<IViewComponentResult> InvokeAsync()
    {
        ...
        return View("~/Themes/Mdw/Components/Toolbar/UserMenu/Default.cshtml", menu);
    }
}
