...
namespace AgileCms.AspNetCore.Mvc.UI.Theme.Wbl.Themes.Wbl.Components.Slider;
...
public class SliderViewComponent : AbpViewComponent
{
    ...
    {
        return View("~/Themes/Wbl/Components/Slider/Default.cshtml", new SliderResourceViewModel());
    }
}
