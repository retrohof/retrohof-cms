...
[ThemeName(Name)]
public class WblTheme : ITheme, ITransientDependency
{
    public const string Name = "Wbl";
    ...
    public virtual string GetLayout(string name, bool fallbackToDefault = true)
    {
        switch (name)
        {
            ...
            case WblLayouts.Application:
                return $"~/Themes/Wbl/Layouts/Application.cshtml";
            case WblLayouts.Account:
                return $"~/Themes/Wbl/Layouts/Account.cshtml";
            case WblLayouts.Empty:
...
public static class WblLayouts
{
    public const string Application = "Wbl.Application";

    public const string Account = "Wbl.Account";

    public const string Public = "Wbl.Public";

    public const string Empty = "Wbl.Empty";
}
