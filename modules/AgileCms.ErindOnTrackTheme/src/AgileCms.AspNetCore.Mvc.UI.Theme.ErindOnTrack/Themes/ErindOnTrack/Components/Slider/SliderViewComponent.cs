...
namespace AgileCms.AspNetCore.Mvc.UI.Theme.ErindOnTrack.Themes.ErindOnTrack.Components.Slider;
...
public class SliderViewComponent : AbpViewComponent
{
    ...
    {
        return View("~/Themes/ErindOnTrack/Components/Slider/Default.cshtml", new SliderResourceViewModel());
    }
}
