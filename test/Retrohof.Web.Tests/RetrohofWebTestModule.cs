...
[DependsOn(
    ...
    typeof(RetrohofWebModule),
    typeof(RetrohofApplicationTestModule),
    typeof(RetrohofEntityFrameworkCoreTestModule)
)]
public class RetrohofWebTestModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<IMvcBuilder>(builder =>
        {
            builder.PartManager.ApplicationParts.Add(new CompiledRazorAssemblyPart(typeof(RetrohofWebModule).Assembly));
        });
